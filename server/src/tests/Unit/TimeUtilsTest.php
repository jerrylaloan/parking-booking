...
class TimeUtilsTest extends TestCase
{
    ...
    {
        return [
            [date_create('2022-03-25 09:00:00'), date_create('2022-03-25 11:00:00'), 2.0],
            [date_create('2022-03-25 09:00:00'), date_create('2022-03-25 12:50:00'), 3.83],
            [date_create('2022-03-25 19:00:00'), date_create('2022-03-25 12:50:00'), 6.17],
        ];
    }
